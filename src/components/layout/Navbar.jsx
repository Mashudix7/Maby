      ...
      <div className="glass-panel rounded-2xl border border-white/30 dark:border-white/10 px-4 md:px-8 py-3 md:py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-1">
          ...
          <button
            ...
            className="w-9 h-9 md:w-10 md:h-10 rounded-full flex items-center justify-center text-zinc-400 dark:text-zinc-500 hover:text-rose-400 dark:hover:text-rose-300 hover:bg-white/30 dark:hover:bg-white/10 transition-colors duration-300 shrink-0"
            aria-label="Keluar"
          >
