...
export default function MainLayout({ children, activePage, className = '', fab }) {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-[#1a1517] text-on-background dark:text-[#ede0df] transition-colors duration-300 relative overflow-hidden">
      {/* Ambient background orbs - Optimized for performance (Desktop Only) */}
      <div className="fixed w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-primary-container/20 dark:bg-rose-500/5 rounded-full blur-[40px] md:blur-[60px] top-[-10%] left-[-10%] pointer-events-none z-0 gpu-accel opacity-50 hidden md:block" />
      <div className="fixed w-[250px] md:w-[400px] h-[250px] md:h-[400px] bg-secondary-container/20 dark:bg-purple-500/5 rounded-full blur-[40px] md:blur-[60px] bottom-[10%] right-[-5%] pointer-events-none z-0 gpu-accel opacity-50 hidden md:block" />
