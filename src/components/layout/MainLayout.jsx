...
export default function MainLayout({ children, activePage, className = '', fab }) {
  ...
  return (
    <div className="min-h-screen bg-background dark:bg-[#1a1517] text-on-background dark:text-[#ede0df] transition-colors duration-300 relative overflow-hidden">
      ...
      <div className="fixed w-[300px] md:w-[500px] h-[300px] md:h-[500px] bg-primary-container/30 dark:bg-rose-500/10 rounded-full blur-[80px] md:blur-[120px] top-[-10%] left-[-10%] pointer-events-none z-0 gpu-accel" />
      <div className="fixed w-[250px] md:w-[400px] h-[250px] md:h-[400px] bg-secondary-container/30 dark:bg-purple-500/10 rounded-full blur-[80px] md:blur-[120px] bottom-[10%] right-[-5%] pointer-events-none z-0 gpu-accel" />
